...
/* ================================================================
   ...
   ================================================================ */
const iconMap = {
  Car, Wrench, Star, Buildings, Lightbulb, HardHat,
};
...
/* ================================================================
   DECORATIVE PARTICLES -- floating accent particles
   ================================================================ */
      ...
      {[...Array(18)].map((_, i) => (
        <div
          ...
          style={{
            ...
            background: `radial-gradient(circle, rgba(var(--accent-rgb, 212,168,83),${Math.random() * 0.5 + 0.2}) 0%, transparent 70%)`,
...
function HeroSection() {
  ...
  return (
    <section ref={containerRef} className="relative h-screen min-h-[700px] overflow-hidden bg-navy-950">
        ...
        {heroImages.map((_, i) => (
          <button
            ...
            className={`w-[3px] transition-all duration-700 ${
              i === currentSlide ? 'h-10 bg-accent-500' : 'h-4 bg-white/20 hover:bg-white/40'
            }`}
      ...
      <div className="absolute top-[15%] left-0 w-[2px] h-32 sm:h-48 bg-gradient-to-b from-transparent via-accent-500 to-transparent z-20" />
      ...
      >
        ...
        <motion.div
          ...
          className="w-16 h-[2px] bg-gradient-to-r from-accent-500 to-accent-400/50 mb-6 origin-left"
        />
        ...
        <motion.p
          ...
          className="text-accent-400 text-xs sm:text-sm font-semibold uppercase tracking-[0.3em] mb-8"
        ...
        <div className="overflow-hidden">
          {['PRECISION', 'REPAIR', 'FACTORY FINISH.'].map((line, i) => (
            <motion.div
              key={line}
              initial={{ y: '110%' }}
              animate={{ y: 0 }}
            ...
            >
              <h1
                className={`font-heading leading-[0.92] tracking-tight ${
                  i === 1
                    ? 'bg-gradient-to-r from-accent-500 via-accent-400 to-accent-600 bg-clip-text text-transparent italic'
                    : 'text-white'
                }`}
                style={{
        ...
        >
          <Link
            to="/contact"
            className="group relative inline-flex items-center gap-3 bg-accent-500 text-navy-950 px-8 py-4 text-sm uppercase tracking-[0.15em] font-semibold transition-all duration-500 hover:bg-accent-400 hover:shadow-xl hover:shadow-accent-500/20"
            style={{ fontFamily: 'var(--font-sans)' }}
          >
            {hero.ctaPrimary}
          ...
          <Link
            to="/services"
            className="group inline-flex items-center gap-3 border border-white/20 text-white px-8 py-4 text-sm uppercase tracking-[0.15em] font-semibold transition-all duration-500 hover:border-accent-500/50 hover:text-accent-400 hover:bg-white/5"
            style={{ fontFamily: 'var(--font-sans)' }}
          >
            {hero.ctaSecondary}
          </Link>
      ...
      >
        ...
        >
          <ArrowDown size={14} className="text-accent-500/40" />
        </motion.div>
      </motion.div>
...
function MarqueeTicker() {
  const items = ['PANEL BEATING', 'SPRAY PAINTING', 'DENT REMOVAL', 'FRAME ALIGNMENT', 'INSURANCE CLAIMS', 'CUSTOM WORK'];
  const repeated = [...items, ...items, ...items, ...items];

  return (
    <section className="bg-navy-950 border-y border-accent-500/10 py-5 sm:py-6 overflow-hidden">
      <div className="animate-marquee flex whitespace-nowrap">
        {repeated.map((item, i) => (
          <span key={i} className="flex items-center gap-6 sm:gap-8 mx-6 sm:mx-8">
            <span className="text-accent-500/80 font-heading text-lg sm:text-2xl italic tracking-wider">
              {item}
            </span>
            <span className="text-accent-500/20 text-sm">&diams;</span>
          </span>
        ))}
      </div>
    </section>
...
/* ================================================================
   3. SERVICES GRID -- cards with full-bleed photos
   ================================================================ */
  ...
  return (
    <section ref={ref} className="bg-navy-900 py-24 sm:py-32 lg:py-40">
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
        ...
        >
          <div className="w-12 h-[2px] bg-accent-500 mb-6" />
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-6">
            <div>
              <p className="text-accent-500/60 text-xs uppercase tracking-[0.3em] mb-3" style={{ fontFamily: 'var(--font-sans)' }}>Our Expertise</p>
              <h2 className="font-heading text-white leading-[0.92] italic" style={{ fontSize: 'clamp(2rem, 4.5vw, 3.5rem)' }}>
                What We <span className="text-accent-500">Deliver</span>
              </h2>
            </div>
            <Link
              to="/services"
              className="group text-white/30 text-xs uppercase tracking-[0.2em] flex items-center gap-2 hover:text-accent-500 transition-colors"
              style={{ fontFamily: 'var(--font-sans)' }}
            >
              All Services
              ...
              >
                ...
                >
                  ...
                  <div className="absolute top-4 right-5 z-10">
                    <span className="text-accent-500/15 font-heading text-6xl sm:text-7xl italic leading-none">
                      {String(i + 1).padStart(2, '0')}
                    </span>
                  </div>

                  {/* Icon badge */}
                  <div className="absolute top-5 left-5 z-10 w-10 h-10 border border-accent-500/30 flex items-center justify-center bg-navy-950/60 backdrop-blur-sm group-hover:bg-accent-500/20 group-hover:border-accent-500/60 transition-all duration-500">
                    <IconComp size={18} weight="light" className="text-accent-500" />
                  </div>
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6 sm:p-8 z-10">
                    ...
                    <div className="flex items-center gap-2 mt-3 text-accent-500 group-hover:translate-x-1 transition-transform duration-300">
                  ...
                  {/* Bottom accent line */}
                  <div className="absolute bottom-0 left-0 right-0 h-[2px] bg-gradient-to-r from-accent-500 to-accent-400 z-10" />
                </Link>
              </motion.div>
            );
          })}
...
/* ================================================================
   4. PORTFOLIO -- Horizontal scrolling gallery
   ================================================================ */
    ...
    <section ref={containerRef} className="bg-navy-950 py-24 sm:py-32 lg:py-40 overflow-hidden">
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 mb-12 sm:mb-16">
        ...
        >
          <div>
            <div className="w-12 h-[2px] bg-accent-500 mb-6" />
            <p className="text-accent-500/60 text-xs uppercase tracking-[0.3em] mb-3" style={{ fontFamily: 'var(--font-sans)' }}>Selected Works</p>
            <h2 className="font-heading text-white leading-[0.92] italic" style={{ fontSize: 'clamp(2.5rem, 6vw, 5rem)' }}>
              Our <span className="text-accent-500">Portfolio</span>
            </h2>
          </div>
          <Link
            to="/projects"
            ...
            >
              <div className="aspect-[3/4] overflow-hidden relative">
                ...
                <div className="absolute top-5 left-5 z-10">
                  <span className="bg-accent-500/90 text-navy-950 text-[10px] uppercase tracking-[0.2em] px-3 py-1.5 font-semibold" style={{ fontFamily: 'var(--font-sans)' }}>
                    {project.category}
                  </span>
                </div>
              </div>
  ...
  return (
    <section ref={ref} className="relative bg-navy-950 overflow-hidden">
      <div className="absolute inset-0">
        <div className="absolute top-1/2 left-1/4 -translate-y-1/2 w-48 h-48 bg-accent-500/5 rounded-full blur-3xl" />
        <div className="absolute top-1/2 right-1/4 -translate-y-1/2 w-48 h-48 bg-accent-500/5 rounded-full blur-3xl" />
      </div>
      <div className="absolute top-0 left-0 right-0 h-[1px] bg-gradient-to-r from-transparent via-accent-500/40 to-transparent" />
      <div className="absolute bottom-0 left-0 right-0 h-[1px] bg-gradient-to-r from-transparent via-accent-500/40 to-transparent" />
      ...
      <div className="relative max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 py-20 sm:py-24">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-10 sm:gap-16">
          {stats.map((stat, i) => (
            ...
            >
              <div
                className="font-heading text-accent-500 leading-none italic"
                style={{ fontSize: 'clamp(2.8rem, 6vw, 5rem)', textShadow: '0 0 40px rgba(var(--accent-rgb, 212,168,83),0.15)' }}
              >
              ...
              {i < stats.length - 1 && (
                <div className="hidden lg:block absolute right-0 top-1/2 -translate-y-1/2 h-16 w-[1px] bg-gradient-to-b from-transparent via-accent-500/15 to-transparent" />
              )}
            </motion.div>
          ))}
        </div>
    ...
    <section ref={ref} className="bg-navy-950 py-24 sm:py-32 lg:py-40 overflow-hidden">
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            <div className="w-12 h-[2px] bg-accent-500 mb-6" />
            <p className="text-accent-500/60 text-xs uppercase tracking-[0.3em] mb-3" style={{ fontFamily: 'var(--font-sans)' }}>Our Story</p>
            <h2 className="font-heading text-white leading-[0.95] italic mb-8" style={{ fontSize: 'clamp(2rem, 5vw, 3.5rem)' }}>
              The {business.name}<br />
              <span className="text-accent-500">Story</span>
            </h2>
            ...
            <div className="flex gap-10 sm:gap-16">
              <div>
                <div className="text-accent-500 font-heading text-3xl sm:text-4xl italic leading-none">{business.established}</div>
                <div className="text-white/30 text-[10px] uppercase tracking-[0.2em] mt-2" style={{ fontFamily: 'var(--font-sans)' }}>Founded</div>
              </div>
              <div>
                <div className="text-accent-500 font-heading text-3xl sm:text-4xl italic leading-none">{business.projectsCompleted}</div>
                <div className="text-white/30 text-[10px] uppercase tracking-[0.2em] mt-2" style={{ fontFamily: 'var(--font-sans)' }}>Completed</div>
              </div>
              <div>
                <div className="text-accent-500 font-heading text-3xl sm:text-4xl italic leading-none">{business.employees}</div>
                <div className="text-white/30 text-[10px] uppercase tracking-[0.2em] mt-2" style={{ fontFamily: 'var(--font-sans)' }}>Team Members</div>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="relative">
              <div className="overflow-hidden">
                <img
                  src={hero.backgroundImages?.[0]?.url || 'https://images.unsplash.com/photo-1580273916550-e323be2ae537?w=800&q=80'}
                  alt={`${business.name} story`}
              ...
              <div className="absolute -bottom-8 -left-6 sm:-left-10 w-[45%] overflow-hidden border-4 border-navy-950 shadow-2xl">
                <img
                  src={hero.backgroundImages?.[1]?.url || 'https://images.unsplash.com/photo-1487754180451-c456f719a1fc?w=600&q=80'}
                  alt={`${business.name} detail`}
                  className="w-full aspect-square object-cover object-center"
                  loading="lazy"
                />
              </div>
              <div className="absolute -top-4 -right-4 sm:-right-6 bg-accent-500 text-navy-950 p-5 sm:p-7 shadow-2xl">
              ...
              <div className="absolute -top-3 -left-3 w-16 h-16 border-t-2 border-l-2 border-accent-500/30" />
            </div>
          </motion.div>
        </div>
      </div>
    ...
    <section ref={ref} className="bg-navy-900 py-24 sm:py-32 lg:py-40 overflow-hidden">
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          ...
          >
            <img
              src={siteData.hero.backgroundImages?.[0]?.url || 'https://images.unsplash.com/photo-1580273916550-e323be2ae537?w=800&q=80'}
              alt={`Why choose ${business.name}`}
              className="w-full aspect-[4/5] object-cover object-center"
              loading="lazy"
            />
            <div className="absolute -top-3 -left-3 w-20 h-20 border-t-2 border-l-2 border-accent-500/40" />
            <div className="absolute -bottom-3 -right-3 w-20 h-20 border-b-2 border-r-2 border-accent-500/40" />
          </motion.div>
          ...
          >
            <div className="w-12 h-[2px] bg-accent-500 mb-6" />
            <p className="text-accent-500/60 text-xs uppercase tracking-[0.3em] mb-3" style={{ fontFamily: 'var(--font-sans)' }}>The Difference</p>
            <h2 className="font-heading text-white leading-[0.95] italic mb-12" style={{ fontSize: 'clamp(2rem, 4.5vw, 3rem)' }}>
              Why Choose <span className="text-accent-500">{business.name}</span>
            </h2>

            <div className="space-y-8">
              {about.values.map((point, i) => (
                <motion.div
                  key={point.title}
                  initial={{ opacity: 0, y: 20 }}
                  animate={inView ? { opacity: 1, y: 0 } : {}}
                ...
                >
                  <div className="shrink-0 mt-1">
                    <div className="w-8 h-8 border border-accent-500/30 flex items-center justify-center bg-accent-500/5">
                      <CheckCircle size={16} weight="fill" className="text-accent-500" />
                    </div>
                  </div>
                  <div>
...
/* ================================================================
   8. TESTIMONIALS -- Auto-cycling with photo avatars
   ================================================================ */
  ...
  return (
    <section ref={ref} className="relative bg-navy-950 py-24 sm:py-32 lg:py-40 overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-5 sm:px-8 lg:px-12">
        ...
        >
          <Quotes size={48} weight="fill" className="text-accent-500/15 mx-auto mb-8" />
              ...
              <div className="flex flex-col items-center gap-3">
                {t.avatar && (
                  <img
                    src={t.avatar}
                    alt={t.name}
                    className="w-12 h-12 rounded-full object-cover object-center border-2 border-accent-500/30"
                    loading="lazy"
                  />
                )}
                <div className="w-8 h-[2px] bg-accent-500" />
                ...
                <div className="flex items-center gap-0.5 mt-1">
                  {[...Array(t.rating)].map((_, i) => (
                    <Star key={i} size={12} weight="fill" className="text-accent-500" />
                  ))}
                </div>
              </div>
            </motion.div>
          ...
          <div className="flex items-center justify-center gap-6 mt-12">
            <button
              onClick={prev}
              className="w-10 h-10 border border-white/10 flex items-center justify-center text-white/30 hover:text-accent-500 hover:border-accent-500/30 transition-colors duration-300"
              ...
              {homeTestimonials.map((_, i) => (
                <button
                  ...
                  className={`h-[2px] transition-all duration-500 ${
                    i === active ? 'w-10 bg-accent-500' : 'w-3 bg-white/10 hover:bg-white/25'
                  }`}
...
/* ================================================================
   9. CTA SECTION -- Cinematic full-bleed with parallax
   ================================================================ */
function CTASection() {
    ...
    <section ref={ref} className="relative py-28 sm:py-36 lg:py-48 overflow-hidden">
      <motion.div className="absolute inset-0" style={{ y: bgY }}>
        <img
          ...
          alt={`${business.name} call to action`}
      ...
      <div className="relative z-20 max-w-5xl mx-auto px-5 sm:px-8 lg:px-12 text-center">
        ...
        >
          <div className="w-16 h-[2px] bg-accent-500 mx-auto mb-8" />

          <h2
            className="font-heading text-white leading-[0.92] italic mb-8"
            style={{ fontSize: 'clamp(2.5rem, 8vw, 6rem)' }}
          >
            {homeCta.title.split(' ').slice(0, 2).join(' ')}<br />
            <span className="text-accent-500">{homeCta.title.split(' ').slice(2).join(' ')}</span>
          </h2>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              to="/contact"
              className="group relative inline-flex items-center gap-3 bg-accent-500 text-navy-950 px-8 py-4 text-sm uppercase tracking-[0.15em] font-semibold transition-all duration-500 hover:bg-accent-400 hover:shadow-xl hover:shadow-accent-500/25"
              style={{ fontFamily: 'var(--font-sans)' }}
            >
              {homeCta.ctaPrimary}
              <ArrowRight size={16} className="transition-transform group-hover:translate-x-1" />
          ...
          <div className="mt-16 pt-8 border-t border-white/5 flex flex-col sm:flex-row items-center justify-center gap-6 text-xs text-white/25 uppercase tracking-[0.15em]" style={{ fontFamily: 'var(--font-sans)' }}>
            <a href={`tel:${business.phoneRaw}`} className="flex items-center gap-2 hover:text-accent-500 transition-colors">
